        ...
        <div class="head">
           ...
           <!--  <ul class="buttons">
                <li class="active">
                    ...
                    <ul class="dd-list">
                        <li><?php echo CHtml::link('<span class="isw-plus"></span> Thêm tài liệu',array('order/create'))?></li>
                    </ul>
                </li>
            </ul> -->
            <div class="clear"></div>
 ...
 <?php
            $this->widget('zii.widgets.grid.CGridView', array(
                ...
                'columns'=>array(
                    ...
                    array(
            			'class'=>'CButtonColumn',
                        'template'=>'{detail}{update}{done}{delete}',
                        'buttons' => array(
                            'detail' => array(
                                'label'=>'DETAIL',
                                'url' =>'Yii::app()->baseUrl."/admin/order/detail/id/".$data->orderId',
                                'imageUrl' => false,
                            ...
                            'done'=>array(
                                'label'=>'DONE',
                                'imageUrl' => false,
                                'url' =>'Yii::app()->baseUrl."/admin/order/delivered/id/".$data->orderId',
